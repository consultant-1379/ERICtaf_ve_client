...
define('styles',['require', 'exports', 'module', 'jscore/less/less'], function (require, exports, module) {
    'use strict';
    ...
    text = {
        ...
        finishLoad: function (name, content, onLoad, config) {
            ...
            parser.parse(currentUrl + resourcesUrl + content, function (err, tree) {
                if (err) {
    ...
    if (typeof process !== "undefined" && process.versions && !!process.versions.node) {
        ...
        lessc = require('jscore/less/less');
        // lessc = window.less;
