...
define('jscore/ext/validationPatterns',{
    alphanumeric: {
        title: 'Text with only alpha numeric chars',
        pattern: '^[a-zA-Z0-9\\s]+$'
    },
    integer: {
    ...
    integerPositive: {
        title: 'Should be a positive integer',
        pattern: '^\\+?[0-9]+$'
    },
    ipv4: {
        title: 'This should be a valid IPv4 Address',
        pattern: '((^|\\.)((25[0-5])|(2[0-4]\\d)|(1\\d\\d)|([1-9]?\\d))){4}$'
    },
    ipv6: {
        title: 'This should be a valid IPv6 Address',
    ...
    number: {
        title: 'Should be an integer or a decimal',
        pattern: '^[-\\+]?[0-9]+([\\.,][0-9][0-9]*)?$'
    }
});
...
define('jscore/ext/dom',[
    ...
    Element.prototype = {
        ...
        /**
         * Returns the position of the element relative to the window
         *
         * @method getPosition
         * @beta
    ...
    var dom = {
        ...
        setValidator: function (element, options, required) {
            ...
            var supportedNativeTypes = ['email', 'url', 'password'],
                typeVal = 'text',
                typeDesc;
...
define('jscore/core',[
            ...
            if (this.onDOMAttach) {
                var intervalFunction = function() {
                    if (document.body.contains(this.getElement()._getHTMLElement())) {
                        clearInterval(this._DOMAttachInterval);
                        delete this._DOMAttachInterval;
                        this.onDOMAttach();
                    }
                }.bind(this);

                this._DOMAttachInterval = setInterval(intervalFunction, 1000/24);
            }
        },
    ...
    return {
        ...
        _private: _private,
        version: "1.1.4" // TODO: remove hardcode
    };
});
