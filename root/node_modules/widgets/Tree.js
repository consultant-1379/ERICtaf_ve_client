...
define('widgets/Tree/Tree',[
...
], function (core, WidgetCore, View, TreeItem, domExt, Resolver) {
     ...
     *           <ul>
     *              <li>label: String</li>
     *              <li>icon: String specifying icon name, or object with "name" (String) and "prefix" (String)</li>
        ...
        onViewReady: function () {
            ...
            if (this._parentItem === undefined) {
                ...
                this._eventBus.subscribe('_itemselect', function (item) {
                    if (this._lastSelectedItem && this._lastSelectedItem !== item) {
...
define('widgets/Tree', ['widgets/Tree/Tree'], function (main) { return main; });
