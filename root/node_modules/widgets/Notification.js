...
/*global define*/
define('widgets/Notification/NotificationView',[
    'jscore/core',
    'template!./_notification.html'
...
/*global define, Error, parseInt, setTimeout*/
define('widgets/Notification/Notification',[
    'widgets/WidgetCore',
    './NotificationView'
     ...
     *           </ul>
     *       </li>
     *       <li>icon (Optional): a string used to define an icon to show. You can use any of the icons from ebIcon.</li>
    ...
    return WidgetCore.extend({
        ...
        onViewReady: function () {
            ...
            this.view.getElement().addEventHandler('onDomAttached' ,function () {
                //TODO: Remove timeout after onDomAttached will be fixed
                setTimeout(function () {
                    this.view.show();
                }.bind(this), 1);
            }, this);
...
define('widgets/Notification', ['widgets/Notification/Notification'], function (main) { return main; });
