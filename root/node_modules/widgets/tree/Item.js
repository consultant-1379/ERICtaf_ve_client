...
define('template!widgets/tree/Item/_item.html',['jscore/handlebars/handlebars'],function (Handlebars) { return Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
...
define('widgets/tree/Item/ItemView',[
    'jscore/core',
    'template!./_item.html',
...
define('widgets/tree/Item/Item',[
    'widgets/WidgetCore',
    'jscore/core',
    './ItemView',
    'widgets/tree/Resolver'
], function (WidgetCore, core, View, Resolver) {
    ...
    return WidgetCore.extend({
        ...
        onViewReady: function () {
            ...
            this.view.getItemContent().addEventHandler('click', function (e) {
                //if (this.getDefinition().disabled === undefined || this.getDefinition().disabled === false) {
       ...
       /* enable: function() {
        ...
        /**
         * Sets the modifier for selection
         *
         * @method select
         * @private
         */
        select: function() {
            this.view.getItemContent().setModifier('selected');
        },

        /**
         * Removes the modifier for selection
         *
         * @method deselect
         * @private
         */
        deselect: function() {
            this.view.getItemContent().removeModifier('selected');
        }
...
define('widgets/tree/Item', ['widgets/tree/Item/Item'], function (main) { return main; });
