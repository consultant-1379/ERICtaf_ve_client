...
], function (WidgetCore, View, datePickerUtils) {
...
], function (WidgetCore, View, DaysRows, datePickerUtils, parserUtils, domUtils) {
        ...
        onViewReady: function () {
            ...
            domUtils.delegate(view.getTable(), 'span:not(.ebDatePicker-day_other):not(.ebDatePicker-day_disabled)', 'click', function (event) {
                ...
                if (day && !isNaN(day)) {
                    ...
                    render.call(this);
                    this.trigger('dateselect', this._selectedDate);
                }
            }, this);
