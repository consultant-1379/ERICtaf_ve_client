...
define('widgets/Spinner/Spinner',[
...
], function (WidgetCore, View, parserUtils) {
    ...
    return WidgetCore.extend({
        ...
        onViewReady: function () {
            ...
            this.view.getInput().addEventHandler('click', selectAllInput, this);
            this.view.getInput().addEventHandler('keypress', handleKeyPress, this);
            this.view.getInput().addEventHandler('keyup', handleKeyUp, this);
            this.view.getInput().addEventHandler('blur', handleInputBlur, this);
        },
    ...
    function handleKeyPress(event) {
        ...
        if (whichKey < 45 || (whichKey >= 112 && whichKey <= 123) || event.originalEvent.ctrlKey) {
